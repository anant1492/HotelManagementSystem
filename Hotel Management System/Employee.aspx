...
<body style="height: 758px; width: 1207px;">
    <form id="form1" runat="server">
        ...
        <br />
        <asp:Panel ID="Panel1" runat="server" BackColor="#669999" Height="603px" style="margin-top: 0px" Width="1164px">
            &nbsp;&nbsp;
            <br />
            &nbsp;&nbsp;&nbsp;
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label8" runat="server" Text="Added By"></asp:Label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="Button1" runat="server" Height="78px" Text="Add Employee" Width="329px" />
            &nbsp;
        </asp:Panel>
    </form>
</body>
